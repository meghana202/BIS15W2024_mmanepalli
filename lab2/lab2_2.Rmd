...
```
The 15th element of my_vector_sequence has a value of 15. 
...
```{r}
tot_earnings <-colSums(all_harry_potter_matrix)
```
The US: 2389.7, Non US: 5332.9

2. Add this information to the data matrix. Hint: you are adding a row, not a column.  
```{r}
new_hp_matrix <- rbind(all_harry_potter_matrix, tot_earnings)
new_hp_matrix
```
