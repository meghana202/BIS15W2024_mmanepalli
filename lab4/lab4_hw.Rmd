...
vore <- select(homerange, "trophic.guild", "species")
table(vore$trophic.guild)
...
```
Herbivores haev a larger mean.hra.m2.
...
owls_df
```
The smallest owl appears to be the Glaucidium passerinum, the Eurasian pygmy owl. It is a small reddish-brown owl with spots. 
...
#View(birds)
```
I viewed the birds and sorted the log10 and meanhra by highest to lowest, showing that the crested caracara (caracara cheriway) is the bird with the largest range.They can live up to 25 years in the wild.
